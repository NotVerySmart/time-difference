window.onload = function () {
    const timestamp = "2018-11-13 23:59:59"; //this is a UTC timestamp
    const TandD = new TimeDifference(timestamp);
    document.getElementById('mainDiv').innerHTML = TandD.returnCalculation();
}
